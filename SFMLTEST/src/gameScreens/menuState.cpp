...
Vector2f middleScreen = { GetScreenWidth() / 2.0f,GetScreenHeight() / 2.0f };
extern Font customFont;

Vector2f Screen = { GetScreenWidth() / 2.0f,GetScreenHeight() / 2.0f };
...
void statesMenu(GameStates& gamestate)
{
	...
	Vector2f mousePoint = GetMousePosition();
