...
Texture powerUpSniperTexture;
Texture powerUpPiercingTexture;
namespace GameObjects
{
	...
	void drawPowerUp(PowerUp powerUp)
	{
		...
		Vector2f pos = { static_cast<float>(powerUp.texture.width) / 2.0f,static_cast<float>(powerUp.texture.height) / 2.0f };
#if _DEBUG
